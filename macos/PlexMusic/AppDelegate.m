...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"PlexMusic"];
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit PlexMusic" action:@selector(terminate:) keyEquivalent:@"q"];
